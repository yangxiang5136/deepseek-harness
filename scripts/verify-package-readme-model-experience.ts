...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-taskflow': { kind: 'none', reason: 'Browser-side attention bar over the bus ledger; registers nothing model-facing.' },
  ...
  'packages/host/taskflow': { kind: 'none', reason: 'Host-side file plane over the bus ledger and todo files; registers nothing model-facing.' },
